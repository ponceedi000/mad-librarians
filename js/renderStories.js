...
function createStarWarsStory(array) {
  let storyText = `The Power of the Force\n  The Force is a mystical ${array[0]} power. As Jedi Master Obi-Wan Kenobi once said, “The Force is an energy field, created buy all living ${array[1]}, that surrounds us, penetrates us, and binds the ${array[2]} together.” Using the power of the force, a Jedi can do many ${array[3]} things, like using the Force to exercise ${array[4]} control over ${array[5]}-minded ${array[6]}. A jedi can also use the Force to move objects with his or her ${array[7]}. It doesn’t matter how ${array[8]} these objects are; it only matters how ${array[9]} the Jedi believes in the Force. Most importantly, the Force teaches a Jedi to rely on his or her feelings. As Obi-Wan Kenobi told his student, Luke ${array[10]}.`;

  return storyText;
}

function createMonsterIncStory(array) {
  let storyText = `After years of using screams to fuel power creation, Monster, Inc. has decided to switch to ${array[0]}. Mike and Sully, the top scarers of Monsters, Inc. are having a hard time with this transition. Mike has try tried ${array[1]} on ${array[2]} while holding a ${array[3]} to get the children ${array[4]} but it just wouldn't work. Mike was ${array[5]} to try something new. He only knew how to get children to scream with his ${array[6]} ${array[7]}. After ${array[8]}, Mike and Sully were able to create the fuel needed to run their ${array[9]}.`;

  return storyText;
}

function createHorrorStory(array) {
  let storyText = `Yesterday, I was ${array[0]}ing on the street. I saw a ${array[1]} house with ${array[2]} windows. I went inside. Suddenly, the door blasted open! I was very ${array[3]}. Then, a masked ${array[4]} ${array[5]} me! I ${array[6]} the masked figure in the ${array[7]}. I ${array[8]} the masked figure and ran outside......until he ${array[9]} me....Am I dead or alive?`;

  return storyText;
}

function createHarryPotterStory(array) {
  let storyText = `Once there was a young ${array[0]} named Harry Potter. Harry lived with his aunt, uncle and his ${array[1]} cousin Dudley on Pivot Drive. One day, an ${array[2]} came with a letter for Harry which read "Dear Mr. Potter, we are pleased to inform you that you have a place at Hogwarts School of Witchcraft and Wizardry. Please find an enclosed list of all necessary books and equipment." Harry was ${array[3]} and his suspicions were true, he really was a ${array[4]} wizard after all!
  Harry read on to the second page with requirements, which says: First-year students will require:\n
  1. Three sets of plain work ${array[5]}.\n 2. One ${array[6]} hat for day wear.\n 3. One pair of protective ${array[7]}.\n 4. One winter cloak (black, with silver fastenings).\n\n Please note that all pupil's clothes should carry name ${array[8]}. Harry couldn't wait to learn ${array[9]} magic.`;
